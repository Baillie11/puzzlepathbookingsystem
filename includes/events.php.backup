    ...
    <div class="wrap">
        ...
        <form method="post" action="">
            ...
            <table class="form-table">
                ...
                <tr>
                    <th scope="row"><label for="display_on_site">Display on Site</label></th>
                    <td>
                        <label><input type="checkbox" name="display_on_site" id="display_on_site" value="1" <?php echo ($edit_event && $edit_event->display_on_site) ? 'checked' : ''; ?>> Show this event on the public booking form</label>
                        <p class="description">When checked, this event will appear in the public booking form dropdown.</p>
                    </td>
                </tr>
            </table>
            <?php submit_button($edit_event ? 'Update Event' : 'Add Event'); ?>
