        ...
        <form method="post" action="">
            <table class="form-table">
                ...
                <tr>
                    ...
                    <td>
                        <select name="hosting_type" id="hosting_type" required>
                            ...
                            <option value="self_hosted">Self Hosted (App)</option>
                        </select>
                ...
                <tr id="date_row" style="display: none;">
                    ...
                    <td><input type="datetime-local" name="event_date" id="event_date"></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="number" name="seats" id="seats" min="1" required></td>
                </tr>
            </table>
            <?php submit_button('Add Event', 'primary', 'submit_event'); ?>
        </form>
